...
std::cout << "Usage: rename [OPTIONS] [PATHS]\n"
          ...
          << "  -d [DEPTH]               Set directory depth level for rename operations. If not specified, maximum depth is used. With -cp mode, renames only parent dir(s).\n"
          << "  -c [MODE]                Set the case conversion mode for file and directory names.\n"
          << "  -cp [MODE]               Set the case conversion mode for file and directory names, including parent directories.\n"
          ...
          << "  reverse    Reverse the case of characters in names (e.g., Test => tEST)\n"
          ...
          << "  rspecial   Remove special characters from names (e.g., '@T|e/s\t!' => Test)\n"
          << "  rnumeric   Remove numeric characters from names (e.g., 1Test2 => Test)\n"
