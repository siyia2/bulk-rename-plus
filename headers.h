...
void rename_folders_with_sequential_numbering(const fs::path& base_directory, std::string prefix, int& dirs_count, int& skipped_folder_count, int depth, bool verbose_enabled, bool symlinks, size_t batch_size_folders);
void rename_folders_with_sequential_numbering(const fs::path& base_directory, std::string prefix, int& dirs_count, int& skipped_folder_count, int depth, bool verbose_enabled, bool symlinks, size_t batch_size_folders);
void rename_folders_with_date_suffix(const fs::path& base_directory, int& dirs_count, int& skipped_folder_count, bool verbose_enabled = false, bool symlinks = false, size_t batch_size_folders = 100, int depth = -1);
