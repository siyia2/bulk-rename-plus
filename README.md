...
Multithreaded at the top level with each input path being assigned to a separate thread and at the low-level where batches of 100 for folders and 1000 for files are processed by separate threads.
