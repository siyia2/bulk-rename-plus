...
Useful for improving the performance of wine windows apps in a case sensitive linux file system and for improving compatibility with some windows wine game mods.
